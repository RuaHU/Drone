...
class WifiConnection:
    ...
    def safe_send(self, packet, sensors = None):
    ...
    def send_command_packet_ack(self, packet, seq_id, sensors = None):
        """
    ...
    def send_param_command_packet(self, command_tuple, param_tuple=None, param_type_tuple=0,ack=True, sensors = None):
        """
...
# in the same way the send_enum_command_packet_ack does.
        ...
        if ack:
            return self.send_command_packet_ack(packet, self.sequence_counter['SEND_WITH_ACK'], sensors)
        else:
